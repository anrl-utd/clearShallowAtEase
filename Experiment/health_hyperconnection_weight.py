...
def define_and_train(iteration, model_name, load_model, weight_scheme, survivability_setting, training_data, training_labels, val_data, val_labels, num_train_epochs, batch_size, num_vars, num_classes, hidden_units, verbose):
    ...
    model_file = 'models/' + str(iteration) + "_" + str(survivability_setting) + "_" + str(weight_scheme) + 'health_hyperconnection.h5'
    ...
    for iteration in range(1,num_iterations+1):   
        ...
        for survivability_setting in survivability_settings:
            ...
            for weight_scheme in weight_schemes:
                ...
                output[model_name][weight_scheme][str(survivability_setting)][iteration-1] = calculateExpectedAccuracy(deepFogGuard_hyperconnection_weight,survivability_setting,output_list,training_labels= training_labels, test_data= test_data, test_labels= test_labels)
