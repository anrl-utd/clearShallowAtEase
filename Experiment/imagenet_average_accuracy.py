...
if __name__ == "__main__":
    ...
    for iteration in range(1,num_iterations+1):
        ...
        deepFogGuard = define_and_train(iteration,"deepFogGuard", load_model, training_data, training_labels, val_data, val_labels, batch_size, classes, input_shape, alpha, default_failout_survival_rate, train_datagen, epochs, progress_verbose, checkpoint_verbose, train_steps_per_epoch, val_steps_per_epoch)
