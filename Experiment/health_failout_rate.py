...
if __name__ == "__main__":
    ...
    for iteration in range(1,num_iterations+1):   
        ...
        for survivability_setting in survivability_settings:
            ResiliNet_failout_rate_variable = define_and_train(iteration, "Variable Failout 1x", load_model, survivability_setting, training_data, training_labels, val_data, val_labels, num_train_epochs, batch_size, num_vars, num_classes, hidden_units, verbose)
        ...
        for failout_survival_setting in failout_survival_settings:
            # node-wise dropout
            ResiliNet_failout_rate_fixed = define_and_train(iteration, "Variable Failout 1x", load_model, failout_survival_setting, training_data, training_labels, val_data, val_labels, num_train_epochs, batch_size, num_vars, num_classes, hidden_units, verbose)
